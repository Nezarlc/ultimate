      ...
      <WalletModalProvider>
        ...
        <div className={styles.tituloTLW}>
          <div className={styles.enlaces}>
            <Image className={styles.enlace} src="/telegram.png" alt="Preview of NFTs" width={170} height={44} priority />
            <Image className={styles.enlace} src="/twitter.png" alt="Preview of NFTs" width={170} height={44} priority />
