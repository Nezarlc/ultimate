      ...
      <WalletModalProvider>
        ...
        <div className={styles.tituloTLW}>
          <div className={styles.divImage}>
            <Image src="/titulo1.png" alt="Preview of NFTs" width={397} height={84} priority />
            <Image src="/pinksale.png" className='photoMiddle' alt="Preview of NFTs" width={50} height={50} priority />
            <Image src="/beta.png" className='photoMiddle' alt="Preview of NFTs" width={100} height={60} priority />
            <Image src="/titulo2.png" alt="Preview of NFTs" width={397} height={84} priority />
          </div>
        </div>
